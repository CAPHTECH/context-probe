...
import {
  ...
  FAMILY_SPECS,
  specForFamily,
  type WeightedSignalSet,
} from "./architecture-pattern-runtime-resolution-shared.js";
import type { PatternRuntimeFinding, SelectedPatternRuntimeSpec } from "./architecture-pattern-runtime-types.js";

export { clamp01, unique } from "./architecture-pattern-runtime-resolution-shared.js";
